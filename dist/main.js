	...
	new Vue({
	    ...
	    methods: {
	        ...
	        _updateTodo: function _updateTodo(todoInfo) {
	            ...
	            var status = _store2.default.updateTodoInfo(todoInfo);
	            if (status) {
	                // 提示更新成功 临时使用
	                this.msg = "保存成功";
	        ...
	        setOneTodo: function setOneTodo(todoInfo) {
	    ...
	    created: function created() {
	        this.todoList = _store2.default.getTodoList();
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    updateTodoInfo: function updateTodoInfo(tinfo) {
	        var todoIndex = _.findIndex(todoList, ['id', tinfo.id]);
	        if (~todoIndex) {
	    ...
	    addTodoInfo: function addTodoInfo(tinfo) {
	        todoList.push(tinfo);
	        return 'true';
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoOne = __webpack_require__(5);

	var _todoOne2 = _interopRequireDefault(_todoOne);

	var _todoFilter = __webpack_require__(6);
	...
	exports.default = {
	    ...
	    components: { todoOne: _todoOne2.default, todoFilter: _todoFilter2.default }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performance_mixin = __webpack_require__(12);
	    ...
	    props: {
	        todoItem: {
	            default: function _default() {
	                return _lodash2.default.cloneDeep(initTodo);
	            }
	        }
	    },
	    data: function data() {
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    methods: {
	        setStatus: function setStatus(_status) {
	...
	var simpleI18n = {
	    install: function install(Vue, options) {
	        ...
	        Vue.mixin({
	            ...
	            watch: {
	                language_: function language_(val) {
	        ...
	        Vue.directive('translate', {
	            update: function update(value) {
	                ...
	                this.el.innerHTML = _lodash2.default.get(translateLib, this.vm.language_ + '.' + value, value);
	                this.vm.$on('vue:__changeLanguage', function (lang) {
	                    _this.el.innerHTML = _lodash2.default.get(translateLib, lang + '.' + value, value);
	                    return true;
	                });
	            }
	        });
...
/***/ function(module, exports) {
	...
	exports.default = {
	    CN: {
	        ...
	        'remain': '进行中',
	        'editway': '双击开启编辑',
	        'powerdby': '使用vue.js和materialize.css 构建。'
	    },
	    EN: {
	        'all': 'All',
	        'done': 'Done',
	        ...
	        'powerdby': 'powerd by materialize & vue'
	    }
	};
